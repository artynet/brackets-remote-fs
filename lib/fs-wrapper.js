define(function (require, exports) {
    ...
    var remoteFs = require("file-system"),
        nativeFs = require("fileSystemImpl"),
        fs;

    function showOpenDialog(allowMultipleSelection, chooseDirectories, title, initialPath, fileTypes, callback) {
        fs.showOpenDialog(allowMultipleSelection, chooseDirectories, title, initialPath, fileTypes, callback);
    }

    function showSaveDialog(title, initialPath, proposedNewFilename, callback) {
        fs.showSaveDialog(title, initialPath, proposedNewFilename, callback);
    }
...
//      Initialize watchers for both implementations.
    ...
    function setFs(isRemote) {
        fs = isRemote ? remoteFs : nativeFs;
    }
